...
abi_path = os.path.join(os.path.dirname(__file__), "pec_abi.json")
...
class Contract:
    ...
    def MAX_PRIME_ETERNALS(self) -> ContractFunction:
        return self.contract.functions.MAX_PRIME_ETERNALS()
